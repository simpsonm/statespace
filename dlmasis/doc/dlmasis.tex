...
\item[] Appendix F: Using posterior correlations to understand patterns of ESP.
\item[] Appendix G: Further plots of ESP and log time per 1000 effective draws for different values of $T$.
\end{itemize}
