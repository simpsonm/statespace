...
\end{enumerate}
\end{alg*}\noindent
Once again, this last step is difficult but we demonstrate how to accomplish it when $W$ is a scalar in the local level model in the supplementary materials.
