...
\jarad{why GIS-E rather than eGIS?}
...
\end{align}
for $t=1,2,\cdots,T$. \jarad{why do we have ind and $t=1,2,\cdots,T$ here?} Given a prior $p(\phi)$, the posterior density we are interested in is $p(\phi|y)\propto p(y|\phi)p(\phi)$.
