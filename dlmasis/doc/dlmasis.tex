...
\item[mcfa.R:] This file contains R code for the MCFA smoother in the local level model.

\item[dlmasisfun.R:] This file contains R functions for obtaining simulations from a variety of MCMC algorithms in the local level model, summarizing those simulations, and for simulating data from the model. It depends on \verb0wscalerej.R0 and \verb0mcfa.R0.
...
\item[dlmasismixrun.R:] This file contains R code that uses the functions in \verb0dlmasisfun.R0 and \verb0mcfa.R0 to obtain the simulations discussed in Section \ref{sec:LLM}.

\item[dlmasislongrun.R:] This file contains R code that uses the functions in \verb0dlmasisfun.R0 to obtain simulations for long time series in the local level model used in Appendix N.

\item[plots.R:] This file contains R code that uses output from \verb0dlmasismixrun.R0 to create the plots in the main document and the appendices.
