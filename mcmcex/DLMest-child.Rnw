...
\begin{align*}
  p(W_t & | \gamma_{0:T},\cdots) \propto \exp\left[-\frac{1}{2}\left(A_tL_t\gamma_t - 2B_tL_t\gamma_t\right)\right]p(W_t)
\end{align*}
