...
ggplot(data=newpostcors, aes(x=V.T, y=W.T, fill=Vv2)) + #$
    geom_tile() +
...
ggplot(data=newpostcors, aes(x=V.T, y=W.T, fill=Vw2)) + #$
    geom_tile() +
    scale_fill_gradient2("Corr", low=muted("blue"), high=muted("red"),
                         limits=c(-1,1), mid="white") +
    facet_grid(.~T, scales="free", labeller=label_both) +
...
ggplot(data=newpostcors, aes(x=V.T, y=W.T, fill=Ww2)) + #$
    geom_tile() +
    scale_fill_gradient2("Corr", low=muted("blue"), high=muted("red"),
                         limits=c(-1,1), mid="white") +
    facet_grid(.~T, scales="free", labeller=label_both) +
...
ggplot(data=newpostcors, aes(x=V.T, y=W.T, fill=Wv2)) + #$
    geom_tile() +
    scale_fill_gradient2("Corr", low=muted("blue"), high=muted("red"),
                         limits=c(-1,1), mid="white") +
    facet_grid(.~T, scales="free", labeller=label_both) +
