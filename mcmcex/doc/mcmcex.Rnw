...
<<introduction-child, child='introduction/introduction.Rnw', eval=TRUE>>=
@ 

<<model-child, child='DLMmodel/DLMmodel.Rnw', eval=TRUE>>=
@ 
...
<<<discussion-child, child='discussion/discussion.Rnw', eval=TRUE>>=
@ 
