...
p1 <- plotfun(meltedsam, vars, base, 10, title, .1)
p2 <- plotfun(meltedsam, vars, base, 100, title, 1)
p3 <- plotfun(meltedsam, vars, base, 1000, title, 100)
p1
p2
p3
@ 
...
title <- "Time per effective draw in seconds, T="
p1 <- plotfun(meltedsam, vars, sams, 10, title, .1)
p2 <- plotfun(meltedsam, vars, sams, 100, title, 1)
p3 <- plotfun(meltedsam, vars, sams, 1000, title, 75)
p1
p2
p3
@ 
