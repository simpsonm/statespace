...
ggplot(data=cordat[cordat$T==100,], aes(x=W, y=V, fill=ACV)) +
    geom_tile() +
    scale_fill_gradient2("Corr", low=muted("blue"), high=muted("red"),
                         limits=c(-1,1), mid="white",
                         guide=guide_colorbar(barheight=20)) +
...
ggplot(data=cordat[cordat$T==100,], aes(x=W, y=V, fill=ACW)) +
    geom_tile() +
    scale_fill_gradient2("Corr", low=muted("blue"), high=muted("red"),
                         limits=c(-1,1), mid="white",
                         guide=guide_colorbar(barheight=20)) +
...
ggplot(data=cordat[cordat$T==1000,], aes(x=W, y=V, fill=ACV)) +
    geom_tile() +
    scale_fill_gradient2("Corr", low=muted("blue"), high=muted("red"),
                         limits=c(-1,1), mid="white",
                         guide=guide_colorbar(barheight=20)) +
...
ggplot(data=cordat[cordat$T==1000,], aes(x=W, y=V, fill=ACW)) +
    geom_tile() +
    scale_fill_gradient2("Corr", low=muted("blue"), high=muted("red"),
                         limits=c(-1,1), mid="white",
                         guide=guide_colorbar(barheight=20)) +
